...
def login_page():
    if request.method == 'POST':
        # Redirect to dashboard (using function name, not template filename)
        return redirect(url_for('dashboard'))
    return render_template('login.html')

# Dashboard route (accessible as /dashboard and /dashboard.html)
@app.route('/dashboard')
...
if __name__ == '__main__':
    # Make the "templates" folder if it doesn't exist
